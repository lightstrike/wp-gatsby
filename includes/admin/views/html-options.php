...
<div class="wrap">
	...
	<form action="<?php echo admin_url( 'options-general.php?page=wp-gatsby' ); ?>" method="POST">
		...
		<table class="form-table">
			<tr>
				<th scope="row"><?php _e( 'Development Preview Settings', 'wp-gatsby' ); ?></th>
        <td><p>Checking `Activate Development Preview?` below will automatically push updates and autosaves to your Gatsby development environment.</p></td>
			</tr>
			<tr>
				<th scope="row"><?php _e( 'Activate Development Preview?', 'wp-gatsby' ); ?></th>
        <td>
          <input type='checkbox' name='gatsby_options[dev_preview][activated]' <?php checked( $options['dev_preview']['activated'], 1 ); ?> value='1'>
        </td>
			</tr>
			<tr>
				<th scope="row"><?php _e( 'Gatsby Preview Refresh Token', 'wp-gatsby' ); ?></th>
				<td>
					<input type='text' name='gatsby_options[dev_preview][refresh_token]' value='<?php echo $options['dev_preview']['refresh_token'] ?>' style="width: 500px; max-width: 100%;">
        ...
        <td>
          <input type='text' name='gatsby_options[dev_preview][build_hook]' value='<?php echo $options['dev_preview']['build_hook'] ?>' style="width: 500px; max-width: 100%;">
        ...
        <td>
        <input type='number' name='gatsby_options[dev_preview][autosave_interval]' value='<?php echo $options['dev_preview']['autosave_interval'] ?>' style="width: 500px; max-width: 100%;">
        </td>
			</tr>
			<tr>
        ...
        <td>
          <input type='checkbox' name='gatsby_options[cache][wp_rest_api_cache]' <?php checked( $options['cache']['wp_rest_api_cache'], 1 ); ?> value='1'>
			...
			<tr>
				<th scope="row"><?php _e( 'Production Preview Settings', 'wp-gatsby' ); ?></th>
        ...
        <td>
          <input type='checkbox' name='gatsby_options[prod_preview][activated]' <?php checked( $options['preview']['activated'], 1 ); ?> value='1'>
        </td>
			</tr>
			<tr>
